<template>
    <div class="areaWholesales">
        ...
        <div class="bg-img">
            <img class="icon-back" @click="$router.back()" src="../../assets/images/apply/md_icon_return@2x.png" alt="">
            <img class="bg-desc" src="../../assets/images/apply/md_wz.png" alt="">
            <img class="bg-flow" src="../../assets/images/apply/md_wz_rz@2x.png" alt="">
            <div class="opt-wrapper">
<!--                <p class="cell-type">—经营类型—</p>-->
<!--                <div class="el-select">-->
...
<!--                    </el-select>-->
<!--                </div>-->
                <p class="cell-type">—批发区域—</p>
                <div class="area-wrap top-line sub-line" @click="toggleModalBox(true)">
                    <img class="icon-adress" src="../../assets/images/apply/md_icon_dw@2x.png" alt="">
                    <p class="area-item">{{ selectLocation[1].value}}</p>
                    <p class="area-item">{{ selectLocation[2].value}}</p>
                    <p class="area-item">{{ selectLocation[3].value}}</p>
                    <p class="area-item">{{ selectLocation[4].value}}</p>
                </div>



                <transition name="bounce">
                    <div class="agreement" v-if="isShow">
                        <el-checkbox v-model="checked" /> <span class="is-agre" v-if="checked">已同意</span> <span>《用户协议&用户承诺书》</span>
                    </div>
                </transition>
                ...
                <div class="submit-wrap">
                    <div class="btn-apply" @click="applySubmit">抢先入驻</div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        created() {
            //Wseq
            this.UserSEQ = sessionStorage.getItem('seq');
            // this.getGetdictData(this.UserSEQ);
        },
...
<style scoped>
    .areaWholesales .bg-img {
        ...
        background-image: url("https://ndhimg.520shq.com/UploadFile/ImgFile/20200727/202007271720313772.jpeg");
    }
