<template>
            ...
            <div class="tabBox" :style="{height:tabBoxHeight+'px'}"
                ...
                <div id="tab0" class="statecontent" :class="{'showcontent':'tab0' === navIndex}">
                    <div class="SendingList">
                        <goods :num="navIndex.substr(3)" @reloadOrder="reloadOrder" :datas="datas" ></goods>
                    </div>
                </div>
                <!-- 待支付 -->
                ...
                <div id="tab5" class="statecontent" :class="{'showcontent':'tab4' === navIndex}">
                    ...
                    <goods :num="navIndex.substr(3)" @reloadOrder="reloadOrder" :datas="datas" :title="exitGood==2?'退款成功':''"></goods>
                </div>
                <!-- 已完成 -->
    ...
    <div class="tamepiker">
        ...
        <mt-datetime-picker ref="picker" type="date" v-model="startTime" :startDate="startDate1" year-format="{value} 年"
                            month-format="{value} 月" date-format="{value} 日"
                            @confirm="handleConfirm" :endDate="endDate">
        </mt-datetime-picker>
        <!-- mint datepicker 结束时间-->
        <mt-datetime-picker ref="picker2" type="date" v-model="endTime" :startDate="startDate2" year-format="{value} 年"
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteLeave(to, from, next) {
            if (to.name == 'blockOrderDetail' || to.name == 'busRefuseDetail') {
